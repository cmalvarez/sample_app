...
#        @users = [@user, second, third]
      ...
      end #it "should have the right title" do
  ...
  describe "GET 'show'" do
    ...
    it "should be successful" do
      get :show, :id => @user # o puede ser :id => @user.id
      response.should be_success
    end
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      it "shoud change the user's attributes'" do
        put :update, :id => @user, :user => @attr
        user = assigns(:user)
        @user.reload
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as a non-signed_in user" do
      ...
      it "shoul deny access" do
        delete :destroy, :id => @user
        response.should redirect_to(signin_path)
      end
    
    end #describe "as a non-signed_in user" do
