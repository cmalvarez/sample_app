...
#    microposts
  ...
  def User.authenticate(email, submitted_password)
    user = find_by_email(email) # primero se busca el usuario x email
    # user = User.find_by_email(email) sintáxis equivalente
...
#yo veía que aquí hay un problema, no está la clase o self.authenticate_with_salt revisar
  ...
  private
    ...
    def encrypt_password
      self.salt = make_salt if new_record? #cuando se asigna se usa self.
